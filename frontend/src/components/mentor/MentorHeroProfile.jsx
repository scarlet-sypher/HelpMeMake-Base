...
import { Linkedin, Github, Twitter, MapPin, Calendar, Star, Trophy, Users, Clock, Target } from 'lucide-react';
          ...
          <div className="flex-1 text-center lg:text-left space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center justify-center lg:justify-start space-x-2 mt-2">
                ...
                <p className="text-lg lg:text-xl text-slate-200 font-medium">{title}</p>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-full p-2 border border-white/20 max-w-md mx-auto lg:mx-0">
              <div className="flex justify-between items-center mb-1">
                <span className="text-xs font-medium text-cyan-200">Mentor Rating</span>
                <div className="flex items-center space-x-1">
                  <Star className="text-yellow-400 fill-current" size={14} />
                  <span className="text-xs font-bold text-cyan-200">{rating} ({totalReviews} reviews)</span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-2xl mx-auto lg:mx-0">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20 text-center transform hover:scale-105 transition-all duration-300">
                <div className="flex items-center justify-center mb-1">
                  ...
                  <span className="text-lg font-bold text-cyan-400 ml-1">{stats.totalStudents}</span>
                </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20 text-center transform hover:scale-105 transition-all duration-300">
                <div className="flex items-center justify-center mb-1">
                  ...
                  <span className="text-lg font-bold text-teal-400 ml-1">{stats.completedSessions}</span>
                </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20 text-center transform hover:scale-105 transition-all duration-300">
                <div className="flex items-center justify-center mb-1">
                  ...
                  <span className="text-lg font-bold text-slate-400 ml-1">{stats.responseTime}min</span>
                </div>
              ...
              {/* Rating Display */}
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20 text-center transform hover:scale-105 transition-all duration-300">
                <div className="text-lg font-bold text-yellow-400 mb-1">{rating}⭐</div>
