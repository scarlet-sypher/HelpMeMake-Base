...
const StatCard = ({ icon: Icon, label, value, change, color }) => {
  ...
  return (
    <div className="bg-white/10 backdrop-blur-sm rounded-2xl shadow-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 group relative overflow-hidden">
