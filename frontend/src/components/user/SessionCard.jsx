            ...
            <div className="flex items-start space-x-3 sm:space-x-4 flex-1">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between sm:items-center sm:space-x-2 mb-1">
                  ...
                  <span className={`px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs font-medium border ${getStatusStyles(status)} backdrop-blur-sm flex-shrink-0 sm:hidden`}>
                    {status}
                  </span>
                </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 p-4">
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="text-center text-white mb-8">
          <h1 className="text-3xl font-bold mb-2">Responsive SessionCard Component</h1>
          <p className="text-blue-200">Resize your screen to see how it adapts!</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-blue-200 mb-2">Desktop (≥ 640px):</h3>
              <ul className="space-y-1 text-blue-100">
