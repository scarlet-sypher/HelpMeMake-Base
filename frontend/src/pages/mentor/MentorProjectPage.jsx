              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0 mb-6">
                <div>
                  ...
                  <p className="text-cyan-200">
                    Find and apply to learning projects that match your
                    expertise
                  </p>
                </div>
              </div>
                        ...
                        {[
                          ...
                          <button
                            ...
                            className={`w-full text-left px-4 py-2 text-sm hover:bg-gradient-to-r hover:from-cyan-600/30 hover:to-teal-600/30 transition-colors flex items-center space-x-2 ${
                              sortBy === option.value
                                ? "text-cyan-300 bg-gradient-to-r from-cyan-600/20 to-teal-600/20"
                                : "text-white"
                            }`}
                          >
                            <option.icon size={14} />
